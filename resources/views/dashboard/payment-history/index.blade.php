            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-md-12">
                    <div class="dashboard__content__wraper">
                        ...
                        <p class="page-header-description">View and download invoices for all payment transactions</p>
                        ...
                        <div class="stats-grid">
                            ...
                            <div class="stat-card">
                                ...
                                <div class="stat-card-value currency">{{ $subscription->currency ?? 'GHS' }} {{ number_format($stats['total_revenue'], 2) }}</div>
                            </div>
                        </div>

                        {{-- Filters --}}
                        <div class="filter-section">
                            <form method="GET" action="{{ route('dashboard.payment-history.index') }}" class="row g-3">
                                <div class="col-md-3">
                                    ...
                                    <table class="modern-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($payment->status == 'completed')
                                                        <a href="{{ route('dashboard.payment-history.view-invoice', $payment->id) }}" 
                                                           class="btn-modern btn-modern-primary" target="_blank">View Invoice</a>
                                                        <a href="{{ route('dashboard.payment-history.download-invoice', $payment->id) }}" 
                                                           class="btn-modern btn-modern-success">Download</a>
                                                    @else
