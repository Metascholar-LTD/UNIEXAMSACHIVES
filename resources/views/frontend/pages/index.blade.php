...
<div class="herobannerarea herobannerarea__box herobannerarea__marketplace">
    <div class="container">
        <div class="row justify-content-center ">
            ...
            <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                <div class="herobannerarea__content__wraper text-center">
                    ...
                    <div class="herobannerarea__title">
                        ...
                        <div class="herobannerarea__title__heading__2">
                            <h2>Massive Courses Available for Anyone<span>.</span></h2>
                        </div>
                    </div>
                ...
                <form class="search__form" action="#">
                    <div class="search__form__categories">
                        <div class="icon">
                    ...
                    <input placeholder="Find & Choose your perfect course" type="text">
                ...
                <div class="interactive-buttons-container text-center" style="margin: 40px 0;">
                    <div class="interactive-buttons-wrapper">
                        <button class="interactive-btn interactive-btn-primary" data-action="courses">
                            <svg xmlns="http://www.w3.org/2000/svg" class="btn-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                            </svg>
                            <span>Browse Courses</span>
                        </button>
                        <button class="interactive-btn interactive-btn-secondary" data-action="instructors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="btn-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 11.5V14m0-2.5v-6a1.5 1.5 0 113 0m-3 6a1.5 1.5 0 00-3 0v2a7.5 7.5 0 0015 0v-5a1.5 1.5 0 00-3 0m-6-3V11m0-5.5v-1a1.5 1.5 0 013 0v1m0 0V11m0-5.5a1.5 1.5 0 013 0v3m0 0V11"></path>
                            </svg>
                            <span>Meet Instructors</span>
                        </button>
                        <button class="interactive-btn interactive-btn-success" data-action="free-courses">
                            <svg xmlns="http://www.w3.org/2000/svg" class="btn-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                            </svg>
                            <span>Free Courses</span>
                        </button>
                        <button class="interactive-btn interactive-btn-info" data-action="certificates">
                            <svg xmlns="http://www.w3.org/2000/svg" class="btn-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <button class="interactive-btn interactive-btn-warning" data-action="support">
                            <svg xmlns="http://www.w3.org/2000/svg" class="btn-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="keyfeatures text-center">
                    <ul>
                        <li>
...
<div class="best__categories sp_bottom_100">
    <div class="container">
        <div class="row">
    ...
    <div class="container">
        ...
        <div class="row grid" data-aos="fade-up">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter5 filter2">
                <div class="gridarea__wraper">
                    <div class="gridarea__img">
                        <a href="course-details.html"><img loading="lazy"  src="img/grid/grid_6.png" alt="grid"></a>
                        <div class="gridarea__small__button">
...
<div class="counterarea sp_bottom_50 sp_top_50">
    <div class="container">
        <div class="row">
