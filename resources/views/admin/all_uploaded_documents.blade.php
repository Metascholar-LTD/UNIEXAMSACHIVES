...
<style>
    /* Modern All Exams Archive Page Styles */
    * {
        font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
    }
    
    .all-exams-archive-hero {
    ...
    .all-exams-archive-hero::before {
        ...
        right: 0;
        bottom: 0;
        background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs><pattern id="archive-grid" width="10" height="10" patternUnits="userSpaceOnUse"><path d="M 10 0 L 0 0 0 10" fill="none" stroke="rgba(100,116,139,0.1)" stroke-width="0.5"/></pattern></defs><rect width="100" height="100" fill="url(%23archive-grid)" /></svg>');
        opacity: 0.7;
    }

    .all-exams-archive-hero-content {
        position: relative;
        z-index: 2;
        text-align: center;
    }
    ...
    .all-exams-archive-list {
        display: flex;
        flex-direction: column;
        gap: 1.5rem;
    }

    .all-exam-archive-card {
        display: flex;
        align-items: center;
        border-radius: 16px;
        padding: 1.5rem;
        ...
        <div class="container-fluid full__width__padding">
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-md-12">
                    <!-- Hero Section -->
                    <div class="all-exams-archive-hero">
                        <div class="container">
                            <div class="all-exams-archive-hero-content">
                                <h1 class="hero-title">All Exams Archive</h1>
                                <p class="hero-subtitle">Complete repository of all exams in the system</p>
                    ...
                    <div class="search-filter-section">
                        <div class="container">
                            <div class="search-box">
                                <input type="text" class="search-input" id="searchInput" placeholder="Search all exams by title, course code, or instructor...">
                    ...
                    <div class="exams-section">
                        <div class="container">
                            @if (count($exams) > 0)
                                <div class="all-exams-archive-list">
...
<script>
// Search and Filter functionality for All Exams Archive
document.addEventListener('DOMContentLoaded', function() {
    const searchInput = document.getElementById('searchInput');
    const filterTabs = document.querySelectorAll('.filter-tab');
    const examCards = document.querySelectorAll('.all-exam-archive-card');
