                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4">
                                    <div class="dashboard__form__wraper">
                                            ...
                                            <div class="recipient-option-card" data-option="selected">
                                                <div class="option-header">
                                                    ...
                                                    <div class="option-content">
                                                        ...
                                                        <span class="user-count" id="selected-count">0 users</span>
                                                    </div>
                                                    <div class="option-radio">
                                                        <input class="form-check-input" type="radio" name="recipient_type" 
                                        ...
                                        <div id="user-selector" class="user-selector mt-4" style="display: none;">
                                            <div class="selector-header">
                                                <h6><i class="icofont-search-1"></i> Search & Select Users</h6>
                                                <div class="selector-stats">
                                                    <span class="selected-indicator" id="selected-indicator">0 selected</span>
                                                </div>
                                            </div>
