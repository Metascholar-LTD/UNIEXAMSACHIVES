...
<style>
    ...
    * {
    ...
    .my-exams-hero::before {
        ...
        right: 0;
        bottom: 0;
        background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs><pattern id="my-grid" width="10" height="10" patternUnits="userSpaceOnUse"><path d="M 10 0 L 0 0 0 10" fill="none" stroke="rgba(100,116,139,0.1)" stroke-width="0.5"/></pattern></defs><rect width="100" height="100" fill="url(%23my-grid)" /></svg>');
        opacity: 0.7;
    }

    .my-exams-hero-content {
        position: relative;
        z-index: 2;
        text-align: center;
    }
        ...
        <div class="container-fluid full__width__padding">
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-md-12">
                    <!-- Hero Section -->
                    <div class="pending-exams-hero">
                        <div class="container">
                            <div class="my-exams-hero-content">
                                <h1 class="hero-title">My Exams</h1>
                                <p class="hero-subtitle">View and manage your uploaded exams</p>
                    ...
                    <div class="search-filter-section">
                        <div class="container">
                            <div class="search-box">
                                <input type="text" class="search-input" id="searchInput" placeholder="Search exams by title, course code, or instructor...">
                        ...
                        <div class="container">
                            @if (count($exams) > 0)
                                <div class="pending-exams-list">
                                    @foreach ($exams as $exam)
                                        ...
                                        @endphp
                                        <div class="pending-exam-card pdf-card" data-type="{{ strtolower($exam->exams_type) }}" data-search="{{ strtolower($exam->course_title . ' ' . $exam->course_code . ' ' . $exam->instructor_name) }}">
                            ...
                            @else
                                <div class="no-exams">
                                    <i class="fas fa-file-alt"></i>
                                    <h4>No Exams Yet</h4>
                                    <p>You haven't uploaded any exams yet. Start by uploading your first exam.</p>
                                </div>
                            @endif
                        </div>
                    </div>
