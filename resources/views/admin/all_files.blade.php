...
<style>
    /* Modern All Files Archive Page Styles - Consistent Theme */
    * {
        font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
    }
    
    .all-files-archive-hero {
    ...
    .all-files-archive-hero::before {
        ...
        right: 0;
        bottom: 0;
        background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs><pattern id="all-files-archive-grid" width="10" height="10" patternUnits="userSpaceOnUse"><path d="M 10 0 L 0 0 0 10" fill="none" stroke="rgba(100,116,139,0.1)" stroke-width="0.5"/></pattern></defs><rect width="100" height="100" fill="url(%23all-files-archive-grid)" /></svg>');
        opacity: 0.7;
    }

    .all-files-archive-hero-content {
        position: relative;
        z-index: 2;
        text-align: center;
    }
    ...
    .all-files-archive-list {
        display: flex;
        flex-direction: column;
        gap: 1.5rem;
    }

    .all-files-archive-card {
        display: flex;
        align-items: center;
        border-radius: 16px;
        padding: 1.5rem;
        ...
        <div class="container-fluid full__width__padding">
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-md-12">
                    <!-- Hero Section -->
                    <div class="all-files-archive-hero">
                        <div class="container">
                            <div class="all-files-archive-hero-content">
                                <h1 class="hero-title">All Files Archive</h1>
                                <p class="hero-subtitle">Complete repository of all uploaded files in the system</p>
                    ...
                    <div class="files-section">
                        <div class="container">
                            @if (count($files) > 0)
                                <div class="all-files-archive-list">
...
<script>
// Search and Filter functionality for All Files Archive
document.addEventListener('DOMContentLoaded', function() {
    const searchInput = document.getElementById('searchInput');
    const filterTabs = document.querySelectorAll('.filter-tab');
    const fileCards = document.querySelectorAll('.all-files-archive-card');
