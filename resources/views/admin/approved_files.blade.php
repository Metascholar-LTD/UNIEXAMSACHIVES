...
<style>
    /* Modern Approved Files Page Styles - Consistent Theme */
    * {
    ...
    .approved-files-hero::before {
        ...
        right: 0;
        bottom: 0;
        background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs><pattern id="approved-files-grid" width="10" height="10" patternUnits="userSpaceOnUse"><path d="M 10 0 L 0 0 0 10" fill="none" stroke="rgba(100,116,139,0.1)" stroke-width="0.5"/></pattern></defs><rect width="100" height="100" fill="url(%23approved-files-grid)" /></svg>');
        opacity: 0.7;
    }

    .approved-files-hero-content {
        position: relative;
        z-index: 2;
        text-align: center;
    }
        ...
        <div class="container-fluid full__width__padding">
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-md-12">
                    <!-- Hero Section -->
                    <div class="approved-files-hero">
                        <div class="container">
                            <div class="approved-files-hero-content">
                                <h1 class="hero-title">Approved Files</h1>
                                <p class="hero-subtitle">Access and manage all approved file documents</p>
                    ...
                    <div class="search-filter-section">
                        <div class="container">
                            <div class="search-box">
                                <input type="text" class="search-input" id="searchInput" placeholder="Search approved files by title, depositor, or document ID...">
                            ...
                            @if (count($files) > 0)
                                <div class="approved-files-list">
                                    @foreach ($files as $file)
                                        ...
                                        @endphp
                                        <div class="approved-file-card {{ $isPdf ? 'pdf-file' : ($isDoc ? 'doc-file' : '') }}" data-type="{{ strtolower($extension) }}" data-search="{{ strtolower($file->file_title . ' ' . $file->depositor_name . ' ' . $file->document_id) }}">
...
<script>
// Search and Filter functionality for Approved Files
document.addEventListener('DOMContentLoaded', function() {
    const searchInput = document.getElementById('searchInput');
    const filterTabs = document.querySelectorAll('.filter-tab');
    const fileCards = document.querySelectorAll('.approved-file-card');
