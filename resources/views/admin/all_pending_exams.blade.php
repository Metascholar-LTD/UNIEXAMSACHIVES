...
<style>
    /* Modern All Pending Exams Page Styles */
    * {
    ...
    .all-pending-exams-hero-content {
        position: relative;
        z-index: 2;
        text-align: center;
    }
    ...
    .all-pending-exams-list {
        display: flex;
        flex-direction: column;
        gap: 1.5rem;
    }

    .all-pending-exam-card {
        display: flex;
        align-items: center;
        border-radius: 16px;
        padding: 1.5rem;
        ...
        <div class="container-fluid full__width__padding">
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-md-12">
                    <!-- Hero Section -->
                    <div class="all-pending-exams-hero">
                        <div class="container">
                            <div class="all-pending-exams-hero-content">
                                <h1 class="hero-title">All Pending Exams</h1>
                                <p class="hero-subtitle">Review and approve all pending exams in the system</p>
                    ...
                    <div class="search-filter-section">
                        <div class="container">
                            <div class="search-box">
                                <input type="text" class="search-input" id="searchInput" placeholder="Search all pending exams by title, course code, or instructor...">
                    ...
                    <div class="exams-section">
                        <div class="container">
                            @if (count($exams) > 0)
                                <div class="all-pending-exams-list">
                                    @foreach ($exams as $exam)
                                        @php
                                            $extension = pathinfo($exam->exam_document, PATHINFO_EXTENSION);
                                        @endphp
                                        <div class="all-pending-exam-card pdf-card" data-type="{{ strtolower($exam->exams_type) }}" data-search="{{ strtolower($exam->course_title . ' ' . $exam->course_code . ' ' . $exam->instructor_name) }}">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const examCards = document.querySelectorAll('.all-pending-exam-card');
