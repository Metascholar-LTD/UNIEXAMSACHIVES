...
<style>
    /* Modern User Uploaded Documents Page Styles */
    * {
        font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
    }
    
    .user-uploaded-docs-hero {
    ...
    .user-uploaded-docs-hero::before {
        content: '';
        position: absolute;
        top: 0;
        left: 0;
        right: 0;
        bottom: 0;
        background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs><pattern id="user-uploaded-grid" width="10" height="10" patternUnits="userSpaceOnUse"><path d="M 10 0 L 0 0 0 10" fill="none" stroke="rgba(147,51,234,0.1)" stroke-width="0.5"/></pattern></defs><rect width="100" height="100" fill="url(%23user-uploaded-grid)" /></svg>');
        opacity: 0.7;
    }

    .user-uploaded-docs-hero-content {
        position: relative;
        z-index: 2;
        text-align: center;
    }
    ...
    .hero-title {
        ...
        color: #581c87;
        margin-bottom: 1rem;
        background: linear-gradient(135deg, #581c87 0%, #9333ea 50%, #a855f7 100%);
    ...
    .user-uploaded-docs-list {
        display: flex;
        flex-direction: column;
        gap: 1.5rem;
    }

    .user-uploaded-doc-card {
        display: flex;
        align-items: center;
        border-radius: 16px;
        padding: 1.5rem;
        ...
        <div class="container-fluid full__width__padding">
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-md-12">
                    <!-- Hero Section -->
                    <div class="user-uploaded-docs-hero">
                        <div class="container">
                            <div class="user-uploaded-docs-hero-content">
                                <h1 class="hero-title">My Uploaded Exams</h1>
                                <p class="hero-subtitle">Track and manage all your uploaded exam documents</p>
                    ...
                    <div class="search-filter-section">
                        <div class="container">
                            <div class="search-box">
                                <input type="text" class="search-input" id="searchInput" placeholder="Search your uploaded exams by title, course code, or instructor...">
                    ...
                    <div class="exams-section">
                        <div class="container">
                            @if (count($exams) > 0)
                                <div class="user-uploaded-docs-list">
                            ...
                            @else
                                <div class="no-exams">
                                    ...
                                    <h4>No Exams Uploaded Yet</h4>
                                    <p>You haven't uploaded any exam documents yet. Start by creating your first exam upload!</p>
                                </div>
                            @endif
                        </div>
                    </div>
...
<script>
// Search and Filter functionality for User Uploaded Documents
document.addEventListener('DOMContentLoaded', function() {
    const searchInput = document.getElementById('searchInput');
    const filterTabs = document.querySelectorAll('.filter-tab');
    const examCards = document.querySelectorAll('.user-uploaded-doc-card');
