...
<style>
    /* Modern Approved Exams Page Styles */
    * {
    ...
    .approved-exams-hero::before {
        ...
        right: 0;
        bottom: 0;
        background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs><pattern id="approved-grid" width="10" height="10" patternUnits="userSpaceOnUse"><path d="M 10 0 L 0 0 0 10" fill="none" stroke="rgba(100,116,139,0.1)" stroke-width="0.5"/></pattern></defs><rect width="100" height="100" fill="url(%23approved-grid)" /></svg>');
        opacity: 0.7;
    }

    .approved-exams-hero-content {
        position: relative;
        z-index: 2;
        text-align: center;
    }
        ...
        <div class="container-fluid full__width__padding">
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-md-12">
                    <!-- Hero Section -->
                    <div class="approved-exams-hero">
                        <div class="container">
                            <div class="approved-exams-hero-content">
                                <h1 class="hero-title">Approved Exams</h1>
                                <p class="hero-subtitle">Access and download all approved exams in the system</p>
                    ...
                    <div class="search-filter-section">
                        <div class="container">
                            <div class="search-box">
                                <input type="text" class="search-input" id="searchInput" placeholder="Search approved exams by title, course code, or instructor...">
                    ...
                    <div class="exams-section">
                        <div class="container">
                            @if (count($exams) > 0)
                                <div class="approved-exams-list">
                                    @foreach ($exams as $exam)
                                        @php
                                            $extension = pathinfo($exam->exam_document, PATHINFO_EXTENSION);
                                        @endphp
                                        <div class="approved-exam-card pdf-card" data-type="{{ strtolower($exam->exams_type) }}" data-search="{{ strtolower($exam->course_title . ' ' . $exam->course_code . ' ' . $exam->instructor_name) }}">
...
<script>
// Search and Filter functionality for Approved Exams
document.addEventListener('DOMContentLoaded', function() {
    const searchInput = document.getElementById('searchInput');
    const filterTabs = document.querySelectorAll('.filter-tab');
    const examCards = document.querySelectorAll('.approved-exam-card');
