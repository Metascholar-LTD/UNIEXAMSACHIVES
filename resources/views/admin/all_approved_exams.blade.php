            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-md-12">
                    <div class="dashboard__content__wraper">
                        ...
                        <div class="modern-page-header approved-header">
                            <div class="header-content">
                                <div class="header-left">
                                    ...
                                    <p class="page-subtitle">View and manage all approved examination materials</p>
                                </div>
                        ...
                        <div class="modern-content-section">
                            @if (count($exams) > 0)
                                <div class="modern-exams-grid">
                                    @foreach ($exams as $exam)
                                        <div class="modern-exam-card approved-card">
                            ...
                            @else
                                <div class="empty-state">
                                    ...
                                    <h3 class="empty-title">No Approved Exams</h3>
                                    <p class="empty-description">No exams have been approved yet. Start by reviewing pending submissions.</p>
                                    <a href="{{ route('dashboard.all.pending.exams') }}" class="btn btn-primary">
