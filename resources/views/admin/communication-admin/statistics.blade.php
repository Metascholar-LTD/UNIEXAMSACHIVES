                                ...
                                <div class="stats-panel">
                                    ...
                                    @if($recentActivity->isEmpty())
                                        <div class="empty-state">
                                            ...
                                            <a href="{{ route('admin.communication-admin.create') }}" class="btn btn-primary">
                                                ...
                                                <div class="activity-item">
                                                    ...
                                                    <div class="activity-content">
                                                        <div class="activity-main">
                                                            <h6><a href="{{ route('admin.communication-admin.show', $campaign) }}">{{ Str::limit($campaign->subject, 40) }}</a></h6>
                                                            <p>
